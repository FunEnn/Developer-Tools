...
import { Search, Github, Sun, Moon, ChevronRight } from "lucide-react";
    ...
    <>
      ...
      `}>
        ...
        <div className="h-16 flex items-center px-6 border-b border-gray-200 dark:border-gray-800">
          <h1 className="text-xl font-bold bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 
          ...
          {tools.map((category) => (
            <div key={category.category} className="mb-6">
              ...
              <div className="flex items-center gap-3 mb-3 px-2">
                <h2 className="text-xs font-bold bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 
                               dark:from-pink-400 dark:via-purple-400 dark:to-indigo-400 
                ...
                {/* 渐变分隔线 */}
                <div className="flex-1 h-[1px] bg-gradient-to-r from-pink-200 via-purple-200 to-transparent 
